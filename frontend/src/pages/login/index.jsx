...
export const LoginPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setMessage("Funcionalidade de login ainda não implementada!");
  };
    ...
    <div
      ...
      <div className="bg-[#ffffffcc] rounded-2xl shadow-2xl p-8 max-w-4xl w-full flex flex-col lg:flex-row lg:divide-x divide-gray-300">
        ...
        <div className="lg:w-1/2 p-4 flex flex-col items-center justify-center space-y-4">
            ...
            {/* Google */}
            <button className="w-full lg:w-3/4 py-2 px-4 text-md rounded-md bg-red-300 text-slate-950 hover:bg-red-600 hover:text-white transition shadow-md flex items-center justify-center gap-2">
                <i className="fab fa-google"></i> Continue com Google
            </button>

            {/* Facebook */}
            <button className="w-full lg:w-3/4 py-2 px-4 text-md rounded-md bg-blue-300 text-slate-950 hover:bg-blue-600 hover:text-white transition shadow-md flex items-center justify-center gap-2">
                <i className="fab fa-facebook-f"></i> Continue com Facebook
            </button>

            {/* GitHub */}
            <button className="w-full lg:w-3/4 py-2 px-4 text-md rounded-md bg-slate-400 text-slate-950 hover:bg-slate-600 hover:text-white transition shadow-md flex items-center justify-center gap-2">
        ...
        <div className="lg:w-1/2 p-4 mt-6 lg:mt-0">
          ...
          <h3 className="text-lg font-semibold mb-4 text-gray-700 text-center">Faça login com e-mail:</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full py-2 text-lg font-semibold rounded-md bg-blue-600 text-white hover:bg-blue-950 transition shadow-md">
              Login
            </button>
