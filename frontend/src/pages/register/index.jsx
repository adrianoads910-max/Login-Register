...
export const RegisterPage = () => {
  ...
  const handleRegister = (e) => {
    ...
    setMessage("Cadastro ainda não implementado!");
  };
    return (
        <main>
             <div
            ...
            <div className="bg-white/92 rounded-2xl shadow-2xl p-8 max-w-4xl w-full flex flex-col lg:flex-row lg:divide-x divide-gray-300">
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <div className="space-y-2">
                    <label htmlFor="nickname" className="text-sm font-medium text-gray-700">Apelido (Username):</label>
                    <input
                        type="text"
                        id="nickname"
                        value={nickname}
                    ...
                    <div className="space-y-2">
                    <label htmlFor="confirmPassword" className="text-sm font-medium text-gray-700">Confirme Senha:</label>
                    <input
                        type="password"
                        id="confirmPassword"
